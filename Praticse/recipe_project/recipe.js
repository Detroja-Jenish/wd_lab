const mainContainer =document.querySelector(".mainConatiner");
...
function add_recipe( img_location, Heading, Ingredients, Method ){
    ...
    const heading_text = document.createTextNode(Heading);
    const ingredients_text = document.createTextNode(Ingredients)
    const method_text = document.createTextNode("METHOD :" + " " + Method);
    

    img.setAttribute("src", img_location);
    ...
    recipeContainer.appendChild(break_line);
    recipeContainer.appendChild(method);
    
    mainContainer.appendChild(recipeContainer);
    //mainContainer.appendChild(heading);
    //mainContainer.appendChild(ingredients);
    //mainContainer.appendChild(method);
}

for (var i=0; i<9; i++){
    add_recipe(recipe_data[i].image, recipe_data[i].Name, recipe_data[i].Ingredients, recipe_data[i].Method)
}